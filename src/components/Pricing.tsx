...
const plans = [
  {
    ...
    bullets: [
      ...
      "1 warehouse (Kutaisi, Georgia)",
      "Basic returns portal",
      "Email support",
    ],
    highlight:
      "Perfect for founders making their first EU shipments. Includes AI Assistant.",
  },
  {
    name: "Growth",
    ...
    highlight:
      "Built for brands scaling channels across the EU. Includes AI Assistant.",
  },
  {
    name: "Scale Pro",
    ...
    bullets: [
      ...
      "Shopify/WooCommerce, API access & custom integrations",
      "AI Assistant for instant support",
    ...
    highlight:
      "Enterprise-grade fulfilment with tailored workflows. Includes AI Assistant.",
  },
];
